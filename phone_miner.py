#!/usr/bin/env python3
"""
MICROCORE (MCX) PHONE MINER v5.0 - WITH GOSSIP DISCOVERY
Auto-discovers network without DNS using peer gossip + local cache
...
# Only ONE bootnode IP needed - miners discover others via gossip
BOOTSTRAP_NODES = [
    "200.36.138.198:8080",  # Your Morocco node (WebSocket port)
]
...
class PhoneMiner:
    ...
    async def run(self):
        print(f"\n{'='*60}")
        print(f"📱 MICROCORE PHONE MINER v5.0")
...
async def main():
    print("\n" + "=" * 60)
    print("🔷 MICROCORE PHONE MINER - GOSSIP DISCOVERY 🔷")
    print("=" * 60)
